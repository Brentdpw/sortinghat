<?php
    ...
    $databaselocal = new Database("ID362599_sortinghatBrent.db.webhosting.be", "ID362599_sortinghatBrent", "sortinghatBrent1", "ID362599_sortinghatBrent", 3306);
    //$databaselocal = new Database("localhost", "root", "root", "sortinghat", 3306);